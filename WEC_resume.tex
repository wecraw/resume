...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{\href{https://wecraw.github.io/mood/}{{\underline{mood}}}} $|$ \emph{Spotify API, Javascript, Angular, Github Pages}}{Sept. 2018 -- Oct. 2018}
          \resumeItemListStart
...
\section{Technical Skills}
 ...
 \begin{itemize}[leftmargin=1.41in, label={}]
    ...
    \small{\item{
     ...
     \item{
     \textbf{Frameworks}{: React, Node.js, Next.js, Angular, Bootstrap, Material UI, SCSS }
     }
     \item{
     \textbf{Developer Tools}{: Git, Azure Dev Ops, Jira, AWS, VS Code, Visual Studio, IntelliJ, Copilot, ChatGPT, Quickbase}
     }
     \item{
